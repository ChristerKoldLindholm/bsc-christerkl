...
def main():
    ...
    ap.add_argument("--sample-files", type=int, default=1000, help="If >0, only sample this many files for the experiment.")
    ...
    # Samples files for elbow experiment.
    ...
    np.save(out_root / "sampled_paths.npy", np.array([str(f) for f in files], dtype=object))
